...
- [sabeechen/hassio-google-drive-backup](https://github.com/sabeechen/hassio-google-drive-backup) - Automatically create and sync Home Assistant backups into Google Drive (today)
- [geekofweek/homeassistant](https://github.com/geekofweek/homeassistant) - Example Home Assistant Configs (1 day ago)
...
- [bramkragten/weather-card](https://github.com/bramkragten/weather-card) - Weather Card with animated icons for Home Assistant Lovelace (1 day ago)
- [thomasloven/hass-browser_mod](https://github.com/thomasloven/hass-browser_mod) - 🔹 A Home Assistant integration to turn your browser into a controllable entity - and also an audio player (1 day ago)
- [madmicio/LG-WebOS-Remote-Control](https://github.com/madmicio/LG-WebOS-Remote-Control) - Remote Control for LG TV WebOS (1 day ago)
...
- [ergochat/ergo](https://github.com/ergochat/ergo) - A modern IRC server (daemon/ircd) written in Go. (2 days ago)
...
- [iovisor/gobpf](https://github.com/iovisor/gobpf) - Go bindings for creating BPF programs. (3 days ago)
