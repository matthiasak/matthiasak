...
- [dennybritz/rnn-tutorial-gru-lstm](https://github.com/dennybritz/rnn-tutorial-gru-lstm) - Language Model GRU with Python and Theano (1 day ago)
- [goml/gobrain](https://github.com/goml/gobrain) - Neural Networks written in go (3 days ago)
- [jdeng/gomxnet](https://github.com/jdeng/gomxnet) - Amalgamation and go binding (3 days ago)
- [apache/incubator-mxnet](https://github.com/apache/incubator-mxnet) - Lightweight, Portable, Flexible Distributed/Mobile Deep Learning with Dynamic, Mutation-aware Dataflow Dep Scheduler; for Python, R, Julia, Scala, Go, Javascript and more (3 days ago)
- [gopherdata/gophernotes](https://github.com/gopherdata/gophernotes) - The Go kernel for Jupyter notebooks and nteract. (4 days ago)
- [pingcap/ticdc](https://github.com/pingcap/ticdc) - Change data capture for TiDB (4 days ago)
- [fxsjy/gonn](https://github.com/fxsjy/gonn) - GoNN is an implementation of Neural Network in Go Language, which includes BPNN, RBF, PCN (4 days ago)
- [CorticalComputer/DXNN2](https://github.com/CorticalComputer/DXNN2) - Topology and Parameter Evolving Universal Learning Network platform DXNN MK2 (4 days ago)
- [awalterschulze/gographviz](https://github.com/awalterschulze/gographviz) - Parses the Graphviz DOT language in golang (4 days ago)
- [gonum/plot](https://github.com/gonum/plot) - A repository for plotting and visualizing data (5 days ago)
- [nlpodyssey/spago](https://github.com/nlpodyssey/spago) - Self-contained Machine Learning and Natural Language Processing library in Go (6 days ago)
