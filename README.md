...
- [pterm/pterm](https://github.com/pterm/pterm) - ✨ #PTerm is a modern Go module to beautify console output. Featuring charts, progressbars, tables, trees, and much more 🚀 It&#39;s completely configurable and 100% cross-platform compatible. (2 days ago)
- [oracle/oci-service-operator](https://github.com/oracle/oci-service-operator) - The OCI Service Operator for Kubernetes (OSOK) makes it easy to connect and manage OCI services from a cloud native application running in a Kubernetes environment. (2 days ago)
- [praetorian-inc/gokart](https://github.com/praetorian-inc/gokart) - A static analysis tool for securing Go code (2 days ago)
- [pulumi/pulumi](https://github.com/pulumi/pulumi) - Pulumi - Modern Infrastructure as Code. Any cloud, any language 🚀 (2 days ago)
- [andrewchambers/go-cdclient](https://github.com/andrewchambers/go-cdclient) - Fast implementation of the collectd network protocol for go. (2 days ago)
- [jaskeerat789/Horizontal-Autoscale-Example](https://github.com/jaskeerat789/Horizontal-Autoscale-Example) - An example of Kubernetes&#39; Horizontal Pod Autoscaler using costume metrics. (2 days ago)
- [hashicorp/nomad-openapi](https://github.com/hashicorp/nomad-openapi) - OpenAPI specification and related artifacts for HashiCorp Nomad (2 days ago)
- [mautrix/go](https://github.com/mautrix/go) - A Golang Matrix framework. (2 days ago)
- [matrix-org/gomatrix](https://github.com/matrix-org/gomatrix) - A Golang Matrix client (2 days ago)
- [gofiber/fiber](https://github.com/gofiber/fiber) - ⚡️ Express inspired web framework written in Go (3 days ago)
- [jostmey/rwa](https://github.com/jostmey/rwa) - Machine Learning on Sequential Data Using a Recurrent Weighted Average (6 days ago)
- [NOX73/go-neural](https://github.com/NOX73/go-neural) - Neural network implementation on golang (6 days ago)
- [create-go-app/cli](https://github.com/create-go-app/cli) - ✨ Create a new production-ready project with backend, frontend and deploy automation by running one CLI command! (6 days ago)
- [vectorizedio/redpanda](https://github.com/vectorizedio/redpanda) - Redpanda is the real-time engine for modern apps.  Kafka API Compatible; 10x faster 🚀    See more at vectorized.io/redpanda (6 days ago)
- [samuel/go-opencl](https://github.com/samuel/go-opencl) - OpenCL bindings for Go (6 days ago)
