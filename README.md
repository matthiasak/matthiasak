...
- [sabeechen/hassio-google-drive-backup](https://github.com/sabeechen/hassio-google-drive-backup) - Automatically create and sync Home Assistant backups into Google Drive (2 days ago)
- [geekofweek/homeassistant](https://github.com/geekofweek/homeassistant) - Example Home Assistant Configs (3 days ago)
...
- [bramkragten/weather-card](https://github.com/bramkragten/weather-card) - Weather Card with animated icons for Home Assistant Lovelace (3 days ago)
- [thomasloven/hass-browser_mod](https://github.com/thomasloven/hass-browser_mod) - 🔹 A Home Assistant integration to turn your browser into a controllable entity - and also an audio player (3 days ago)
- [madmicio/LG-WebOS-Remote-Control](https://github.com/madmicio/LG-WebOS-Remote-Control) - Remote Control for LG TV WebOS (3 days ago)
...
- [ergochat/ergo](https://github.com/ergochat/ergo) - A modern IRC server (daemon/ircd) written in Go. (4 days ago)
...
- [knqyf263/pet](https://github.com/knqyf263/pet) - Simple command-line snippet manager, written in Go. (5 days ago)
- [golang/go](https://github.com/golang/go) - The Go programming language (5 days ago)
- [iovisor/gobpf](https://github.com/iovisor/gobpf) - Go bindings for creating BPF programs. (5 days ago)
...
- [opencve/opencve](https://github.com/opencve/opencve) - CVE Alerting Platform (5 days ago)
