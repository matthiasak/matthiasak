...
- [Immutable Secrets and ConfigMaps: One of the most desirable controls for Kubernetes in the last few years, IMHO](https://keas.app/immutable-secrets-and-configmaps-one-of-the-most-desirable-controls-for-kubernetes-in-the-last-few-years-imho/) (3 months ago)
- [I have not heard of the &#34;CPaaS&#34; approach before](https://keas.app/i-have-not-heard-of-the-cpaas-approach-before/) (3 months ago)
- [K8s CSI now supports monitoring the health of volumes](https://keas.app/k8s-csi-now-supports-monitoring-the-health-of-volumes/) (3 months ago)
- [An interesting note on annotations in K8s for humans](https://keas.app/an-interesting-note-on-annotations-in-k8s-for-humans/) (3 months ago)
- [K8s now gracefully reschedules pods before a node is shutdown](https://keas.app/k8s-now-gracefully-reschedules-pods-before-a-node-is-shutdown/) (3 months ago)
- [How Kubernetes Secrets Stay Secret](https://keas.app/how-kubernetes-secrets-stay-secret/) (3 months ago)
...
- [aunum/gold](https://github.com/aunum/gold) - Reinforcement Learning in Go (1 day ago)
- [owulveryck/lstm](https://github.com/owulveryck/lstm) - LSTM based on go and gorgonia (1 day ago)
- [JRC1995/DemonRangerOptimizer](https://github.com/JRC1995/DemonRangerOptimizer) - Quasi Hyperbolic Rectified DEMON Adam/Amsgrad with AdaMod, Gradient Centralization, Lookahead, iterative averaging and decorrelated Weight Decay (1 day ago)
- [google-research/google-research](https://github.com/google-research/google-research) - Google Research (4 days ago)
- [huggingface/accelerate](https://github.com/huggingface/accelerate) - 🚀 A simple way to train and use PyTorch models with multi-GPU, TPU, mixed-precision (4 days ago)
...
- [huggingface/awesome-huggingface](https://github.com/huggingface/awesome-huggingface) - 🤗 A list of wonderful open-source projects &amp; applications integrated with Hugging Face libraries. (4 days ago)
- [salesforce/ai-economist](https://github.com/salesforce/ai-economist) - Foundation is a flexible, modular, and composable framework to model socio-economic behaviors and dynamics with both agents and governments. This framework can be used in conjunction with reinforcement learning to learn optimal economic policies, as done by the AI Economist (https://www.einstein.ai/the-ai-economist). (4 days ago)
- [dataman-git/codes_for_articles](https://github.com/dataman-git/codes_for_articles) -  (4 days ago)
- [keras-team/keras](https://github.com/keras-team/keras) - Deep Learning for humans (4 days ago)
- [dennybritz/rnn-tutorial-gru-lstm](https://github.com/dennybritz/rnn-tutorial-gru-lstm) - Language Model GRU with Python and Theano (6 days ago)
- [goml/gobrain](https://github.com/goml/gobrain) - Neural Networks written in go (1 week ago)
- [jdeng/gomxnet](https://github.com/jdeng/gomxnet) - Amalgamation and go binding (1 week ago)
- [apache/incubator-mxnet](https://github.com/apache/incubator-mxnet) - Lightweight, Portable, Flexible Distributed/Mobile Deep Learning with Dynamic, Mutation-aware Dataflow Dep Scheduler; for Python, R, Julia, Scala, Go, Javascript and more (1 week ago)
- [gopherdata/gophernotes](https://github.com/gopherdata/gophernotes) - The Go kernel for Jupyter notebooks and nteract. (1 week ago)
- [pingcap/ticdc](https://github.com/pingcap/ticdc) - Change data capture for TiDB (1 week ago)
- [fxsjy/gonn](https://github.com/fxsjy/gonn) - GoNN is an implementation of Neural Network in Go Language, which includes BPNN, RBF, PCN (1 week ago)
