...
- [twmb/franz-go](https://github.com/twmb/franz-go) - franz-go contains a feature complete, pure Go library for interacting with Kafka from 0.8.0 through 3.0.0&#43;. Producing, consuming, transacting, administrating, etc. (1 day ago)
- [pterm/pterm](https://github.com/pterm/pterm) - ✨ #PTerm is a modern Go module to beautify console output. Featuring charts, progressbars, tables, trees, and much more 🚀 It&#39;s completely configurable and 100% cross-platform compatible. (4 days ago)
- [oracle/oci-service-operator](https://github.com/oracle/oci-service-operator) - The OCI Service Operator for Kubernetes (OSOK) makes it easy to connect and manage OCI services from a cloud native application running in a Kubernetes environment. (4 days ago)
- [praetorian-inc/gokart](https://github.com/praetorian-inc/gokart) - A static analysis tool for securing Go code (4 days ago)
- [pulumi/pulumi](https://github.com/pulumi/pulumi) - Pulumi - Modern Infrastructure as Code. Any cloud, any language 🚀 (4 days ago)
- [andrewchambers/go-cdclient](https://github.com/andrewchambers/go-cdclient) - Fast implementation of the collectd network protocol for go. (4 days ago)
- [jaskeerat789/Horizontal-Autoscale-Example](https://github.com/jaskeerat789/Horizontal-Autoscale-Example) - An example of Kubernetes&#39; Horizontal Pod Autoscaler using costume metrics. (4 days ago)
- [hashicorp/nomad-openapi](https://github.com/hashicorp/nomad-openapi) - OpenAPI specification and related artifacts for HashiCorp Nomad (4 days ago)
- [mautrix/go](https://github.com/mautrix/go) - A Golang Matrix framework. (4 days ago)
- [matrix-org/gomatrix](https://github.com/matrix-org/gomatrix) - A Golang Matrix client (4 days ago)
